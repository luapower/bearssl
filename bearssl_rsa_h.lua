...
typedef uint32_t (*br_rsa_pss_sign)(const br_prng_class **rng,
 ...
 const br_rsa_private_key *sk, unsigned char *x);
enum {
	BR_HASH_OID_SHA1     = ((const unsigned char *)"\x05\x2B\x0E\x03\x02\x1A"),
	BR_HASH_OID_SHA224   = ((const unsigned char *)"\x09\x60\x86\x48\x01\x65\x03\x04\x02\x04"),
	BR_HASH_OID_SHA256   = ((const unsigned char *)"\x09\x60\x86\x48\x01\x65\x03\x04\x02\x01"),
	BR_HASH_OID_SHA384   = ((const unsigned char *)"\x09\x60\x86\x48\x01\x65\x03\x04\x02\x02"),
	BR_HASH_OID_SHA512   = ((const unsigned char *)"\x09\x60\x86\x48\x01\x65\x03\x04\x02\x03"),
};
